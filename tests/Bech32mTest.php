...
//
        ...
        public function test_decodeSegwit_is_successful()
        {
            ...
            //$this->assertSame($hex_value, $hex);
        }
    }

    /*
   *  $bech32 = new Bech32m;
$hexPuzzle = $this->hexPuzzle;
if(stringStartsWith('0x',$hexPuzzle))$hexPuzzle = substr($hexPuzzle, 2);
return $bech32->encodeSegwit(self::$_prefix,1,hex2bin($hexPuzzle) );
   */

    /**
     *  $bech32 = new Bech32m;
    [$ADDRESS_TO_HEX, $PROGRAM] = $bech32->decodeSegwit(self::$_prefix, $this->address);
    return bin2hex($PROGRAM);
     *
     */